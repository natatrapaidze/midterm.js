...
/*ფინქცია არის კოდის ბლოკი რომელიცც შესრულდება მხოლოდ ფუნციის გამოძახების მომენტში 
js ში იგიი განისაზღვრება სიტყვა function განსაზღვრის შემდეგ მას მოყვება სახელი 

მაგალითად ფუნქცის განსაზღვრა
...
ამ მაგალითის მიხედვით განვსაზღვრავთ ფუნციას რომლის სახელიცაა hellow 
და კოდის ბლოკში ვეუბნებით რომ კონსოლში გამომიტანოს ola მაგრამ ეს მოქმედება არ 
შესრულდება მანამ სანამ არ გამოვიძხებთ ამ ფუნქციას , პუნქცის გამოსაძხებლად გვჭირდება ფუნქციის სახელი 

მაგ:

hellow("nata")

პუნქციის გამოძხების შემდეგ კონსოლში მივიღებტ "ola nata "
ფუნქცია შეგვიძლია გამოვიძახოთ რამდენჯერაც დაგვჭირდება უსასრულოდ.
...
/რა არის პარამეტრები?/;
/* 
პარამეტრი  შეგვიძლია შევქმნათ ფუნქციის განსაზღვრის მომენტში პარამეტრი იწერება 
განსაზღვრული ფუნქცის შემდეგ არსებულ ბრჩხილებში 
...
function hellow(name) {
 ...
 ამ მაგალითის მიხედვით პარაეტრი არის (name)  პარამეტრის საშუალებით შეგვიძლია უკვე 
 გამოცხადებული ფუნქცია შევცვალოთ ერთი ქმედებით და არ დაგვჭირდეს სათითაოდ მიში შეცვლა 
 მაგალითად თუ მე გამოვაცხადებ რამდენიმე ფუნქციას 
...
პუნქცისს პარამეტრით ერთდროულად შემიძლია 3 ფუნქციას კონსოლში დავაპრინტინო
 ola nata , ola doi , ola zoi ამისთვის კოდის ბლოკში უნდა დავწეროთ შემდეგი სინტაქსი 
 ("ola" +  name) ანუ როდესაც ფუნქციას გამოვიძახებ  ola დაუმატე პარამრი name და ისე გამოიტანე კონსოლში.

*/

/რა არის default პარამეტრი?/;

/* Difault პარამეტრი გამოიყენება მაშინ თუ ჩვენ გამოვიძხებთ  ფუნქციას და მას არ გადავცემთ არგუმენტს ანუ 
    hellow() <- ეს არის ფუნქცია არგუმენტის გარეშე რომლის მნიშვნელობა ყოველთვის იქნება განუსაძღვრელი (undefined)
    რადგან არ გააჩნია არგუმენტი ხოლო difault პარამეტრის საშუალებით ეს ფუნქცია შეგვიძლია განვსაზღვროთ შემდეგნაირად 

მაგ


function hellow(name = "world") {
    console.log("ola" +  name)
 }

ამ მაგალითის მიხედვიტ პარამეტრს ვანიჭებთ მნიშვნელობა world რის შედეგადაც ყველა ფუნქცია რომელსაც გამოვიძახებთ 
და მას არ ექნება არგუმენტი (hellow() განისაზღვრება კონსოლში არა როოგორც განუსაძღვრელი (undefined) არამედ როგორც 
ola world რადგან ფუნქციის პარამეტრში თავიდანვე განვსაზღვრეთ როომ თავდაპირველად პარამეტრე name იქნებოდა world .
 ანუ name default -ად იქნებოდა world.
*/
...
/* 
Local scope შემთხვევაში  ცვლადს ვერ განვსაზღვღავთ კოდის ბლოკის გარეთ ან იმ ცვლადს რომელიც
 ეკუთვნის კონკრეტულ ფუნქციას მე ვერ განვსაზღვრავ სხვაა ფუნქციაში .
ყველა ფუნქციას აქვს საკუთარი ლოკალური სკოუპი 

Global scope  შეგვიძლია განვსაზღვროთ ცვლადი  გლობალ სკოუპისას ცვლადი განისაძღვრება გარეთ .
...
ამ მაგალითში ნაჩვენებია  global  . ცვლადისა და ფუნქციის პარამეტრი ერთიდაიმავეაა მაგრამ ეს 
js ხელს არ უშლის წაიკითხოს კოდი რადგან  let name = "georgia" არის გლობალ სკოუპი
